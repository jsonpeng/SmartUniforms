...
class AuthController extends Controller
{
    ...
    private $key = 'wefwefewfewfw321651)(*&(&';
    ...
    public function weixinAuth(Request $request){
        ...
        /*
        $inpusts = $request->all();
        if (array_key_exists('redirect', $inpusts)) {
            Log::info($inpusts);
            $request->session()->put('user_redirect', $inpusts['redirect']);
            Log::info('session user_redirect');
            Log::info($request->session()->get('user_redirect'));
        }
        */
    ...
    protected function recoverAuth(){
