...
class SingelPageController extends AppBaseController
{
    ...
    public function store(CreateSingelPageRequest $request)
    {
        ...
        Flash::success('Singel Page saved successfully.');
    ...
    public function show($id)
    {
        ...
        if (empty($singelPage)) {
            Flash::error('Singel Page not found');
    ...
    public function update($id, UpdateSingelPageRequest $request)
    {
        ...
        Flash::success('Singel Page updated successfully.');
    ...
    public function destroy($id)
    {
        ...
        Flash::success('Singel Page deleted successfully.');
