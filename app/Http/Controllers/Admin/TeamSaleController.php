...
class TeamSaleController extends AppBaseController
{
    ...
    public function __construct(TeamSaleRepository $teamSaleRepo,ProductRepository $productRepo,SpecProductPriceRepository $specProductPriceRepo,FlashSaleRepository $flashSaleRepo)
    {
    ...
    public function index(Request $request)
    {
        ...
        $teamSales=$teamSales->paginate($this->defaultPage());
    ...
    public function store(CreateTeamSaleRequest $request)
    {
        ...
        Flash::success('Team Sale saved successfully.');
    ...
    public function update($id, UpdateTeamSaleRequest $request)
    {
        ...
        Flash::success('Team Sale updated successfully.');
