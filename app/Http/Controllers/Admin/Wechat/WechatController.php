    ...
    public function serve()
    {
        ...
        $app->server->push(function($message) use ($app){
        	switch ($message['MsgType']) {
		            ...
		            switch ($message['Event']) {
                        case 'subscribe':
                            ...
                            if (!empty($message['EventKey'])) {
                                ...
                                $this->userRepository->processRecommendRelation($message['FromUserName'], intval(substr($message['EventKey'], $pos)) );
                            }
		        ...
		        case 'text':
                    //处理激活信息
                    $result = app('commonRepo')->activeMemberCard('微信', $message['Content'], $message['FromUserName']);
