...
class CreateItemsTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('items', function (Blueprint $table) {
            ...
            $table->float('cost')->default(0)->comment('成本价格');
            $table->float('count')->default(0)->comment('商品数量');
            $table->string('unit')->default('')->comment('规格单元');
            ...
            $table->string('register_code')->nullable()->comment('激活码');
