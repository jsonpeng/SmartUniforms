...
class ProductSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // $productTypes = factory(App\Models\ProductType::class, 3)->create();
        // $specs = factory(App\Models\Spec::class, 3)->create();
        // $specItem = factory(App\Models\SpecItem::class, 3)->create();
        // $productAttr = factory(App\Models\ProductAttr::class, 3)->create();
