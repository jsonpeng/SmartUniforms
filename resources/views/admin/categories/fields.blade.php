...
<div class="form-group">
    <label for="recommend" class="col-sm-12 control-label">推荐</label>
    <div class="col-sm-12">
        <?php 
            $rec = 0;
            if ($category) {
                $rec = $category->recommend;
            }
        ?>
        <div class="radio">
            <label>
            <input type="radio" name="recommend" value=1 @if($rec==1) checked="checked" @endif>
            是
            </label>
        </div>
        <div class="radio">
            <label>
            <input type="radio" name="recommend" value=0 @if($rec==0) checked="checked" @endif>
            否
            </label>
        </div>
    </div>
