...
<div class="form-group col-sm-12 col-xs-12">
    {!! Form::label('price', '选择商品:') !!}
     {!! Form::text('product_name', null, ['class' => 'form-control']) !!}
    <button class="btn btn-primary btn-sm daterange" type="button" title="添加商品" onclick="addProductMenuFunc(1)" style="margin-top:15px;"> <i class="fa fa-plus"></i>
    </button>
...
<!-- Price Field -->
<div class="form-group col-sm-12 col-xs-12">
    {!! Form::label('price', '秒杀价格:') !!}
    {!! Form::text('price', null, ['class' => 'form-control']) !!}
</div>

<!-- Product Num Field -->
<div class="form-group col-sm-12 col-xs-12">
    {!! Form::label('product_num', '参与数量:') !!}
    {!! Form::number('product_num', null, ['class' => 'form-control']) !!}
</div>

<!-- Buy Limit Field -->
<div class="form-group col-sm-12 col-xs-12">
    {!! Form::label('buy_limit', '单次最多购买数量:') !!}
