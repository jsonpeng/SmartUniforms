...
<li class="treeview {{ Request::is('zcjy/coupons*') || Request::is('zcjy/couponRules*') ? 'active' : '' }}">
    ...
    <ul class="treeview-menu">
        ...
        <li class="{{ Request::is('zcjy/coupons/given_integer') ? 'active' : '' }}">
...
{{-- <li class="treeview {{ Request::is('zcjy/Promps/pageSet*') ? 'active' : '' }}">
    <a href="#">
        <i class="fa fa-folder"></i> <span>设置</span>
        <span class="pull-right-container">
        <i class="fa fa-angle-left pull-right"></i>
        </span>
    </a>
    <ul class="treeview-menu">
        <li class="{{ Request::is('zcjy/Promps/pageSet*') ? 'active' : '' }}">
            <a href="{!! route('promps.pageset') !!}"><i class="fa fa-edit"></i><span>分页设置</span></a>
        </li>
    </ul>
</li> --}}
...
<!--
<li class="treeview {{ Request::is('zcjy/groupSales*') ? 'active' : '' }}">
    <a href="#">
        <i class="fa fa-folder"></i> <span>团购</span>
        <span class="pull-right-container">
        <i class="fa fa-angle-left pull-right"></i>
        </span>
    </a>
    <ul class="treeview-menu">
        <li class="{{ Request::is('zcjy/groupSales*') ? 'active' : '' }}">
            <a href="{!! route('groupSales.index') !!}"><i class="fa fa-edit"></i><span>团购管理</span></a>
        </li>
    </ul>
</li>
-->