...
<div  class="box-body" >
    ...
    <div class="row" style="background-color: #edfbf8;">
        <div class="col-md-2 col-xs-2 hidden-xs">编号</div>
    ...
    <div class="items row" id="item_row_{!! $item->
        ...
        <div id="item_form_{{ $item->
            id }}">
            <div class="col-md-2 col-xs-2 hidden-xs">{{ $item->id }}</div>
            <div class="col-md-4 col-xs-4">
                <img src="{{ $item->image }}" class="img-auto" alt="">{{ $item->name }}</div>
            <div class="col-md-3 col-xs-5">--</div>

            <div class="col-md-1 col-xs-1" id="item_price_{{ $item->
                id }}">
    ...
    <div class="items row" id="item_row_{!! $item->
        ...
        <div id="item_form_{{ $item->
            ...
            <div class="col-md-4 col-xs-4">
                <img src="{{ $item->
                image }}" class="img-auto" alt="">{{ $item->product()->first()->name }}
            </div>
            <div class="col-md-3 col-xs-5">{{ $item->key_name }}</div>
