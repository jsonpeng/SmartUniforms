...
@section('content')
    <section class="content-header">
        ...
        <h1 class="pull-right">
            <a class="btn btn-primary pull-right" style="margin-bottom: 5px" href="{!! route('products.screate') !!}">添加校服</a>
        </h1>
    </section>
    <div class="content pdall0-xs">
            ...
            <div class="box-body">
               ...
               {{--      <div class="form-group col-lg-2 col-md-4 col-sm-6 col-xs-6">
                    ...
                    <div class="form-group col-lg-2 col-md-3 col-sm-12 col-xs-12">
                       ...
                       <input type="text" class="form-control" name="product_name" placeholder="校服名称" @if (array_key_exists('product_name', $input))value="{{$input['product_name']}}"@endif>
                    </div>
        ...
        <div class="box box-primary">
            <div class="box-body">
                    @include('admin.school_product.table')
            </div>
        </div>
