                    ...
                    <div class="box-body">
                        <form class="form-horizontal" id="form1">
                            ...
                            <div class="form-group">
                                <label for="FUNC_BRAND" class="col-sm-3 control-label">品牌街</label>
                                <div class="col-sm-9">
                                    <div class="radio">
                                        <label>
                                            <input type="radio" name="FUNC_BRAND" value="0" @if( '0' == sysOpen('FUNC_BRAND') )checked="" @endif>关闭</label>
                                    </div>
                                    <div class="radio">
                                        <label>
                                            <input type="radio" name="FUNC_BRAND" value="1" @if( '1' == sysOpen('FUNC_BRAND') )checked="" @endif>开启</label>
                                    </div>
                                </div>
                            </div>
                            @endif
