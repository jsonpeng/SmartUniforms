...
<!-- Product Name Field -->
<div class="form-group col-sm-12 col-xs-12">
    {!! Form::label('product_name', '选择商品:') !!}
    {!! Form::text('product_name', null, ['class' => 'form-control']) !!}
    <button class="btn btn-primary btn-sm daterange" type="button" title="添加商品" onclick="addProductMenuFunc(1,'',true)" style="margin-top:15px;"> <i class="fa fa-plus"></i>
    </button>
    ...
    <div id="seleted_one_goods">
        ...
        <div style="float: left;margin: 10px auto;" class="selected-group-goods">
            ...
            <div class="goods-price">商城价：￥{!! $product->price !!} 库存:{!! $product->inventory !!}</div>
        </div>
        @else
        <!--商品带规格的-->
        <div style="float: left;margin: 10px auto;" class="selected-group-goods">
            ...
            <div class="goods-name">
                <a target="_blank" href="">
                    {!! $product->product()->first()->name !!} {!! $product->key_name !!}
                </a>
            </div>
            <div class="goods-price">商城价：￥{!! $product->price !!} 库存:{!! $product->inventory !!}</div>
        </div>
...
<!-- Expire Hour Field -->
<div class="form-group col-sm-6 col-xs-6">
    {!! Form::label('expire_hour', '开团后有效期(小时数):') !!}
...
<!-- Member Field -->
<div class="form-group col-sm-6 col-xs-6">
    {!! Form::label('member', '成团人数:') !!}
    {!! Form::number('member', null, ['class' => 'form-control']) !!}
</div>

<!-- Buy Limit Field -->
<div class="form-group col-sm-6 col-xs-6">
    {!! Form::label('buy_limit', '每人限购数量:') !!}
