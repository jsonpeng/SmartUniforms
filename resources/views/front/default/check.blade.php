...
<form method="POST" action="/check">
  ...
  <div id="check">
    ...
    @else
      <div class="js_dialog" id="iosDialog2" style="z-index: 999991;">
    ...
    <div class="page__bd section-margin">
      <div class="weui-form-preview">
        <div class="weui-form-preview__hd">
            <div class="weui-form-preview__item">
                <label class="weui-form-preview__label" style="color: #333;">账户余额({{ $user->user_money }})</label>
            </div>
        </div>
        <div class="weui-form-preview__bd">
            <div class="weui-form-preview__item">
  ...
  <script>
    ...
    */
      ...
      $.ajax({
        ...
        success: function(data) {
          if (data.code) {
            ...
            /*
            $('#coupon-list').fadeIn(200);
            $('#coupon-list .content-wrapper').empty();
            */
    ...
    function userAllMoney() {
      var allMoney = money_use = total-order_promp-coupon_money-creditMoney-member_money+freigth;
