...
@section('content')
  <div class="nav_tip">
    <div class="img">
      <a href="/orders"><img src="{{ asset('images/return.png') }}" alt=""></a></div>
      ...
      @if ($order->order_pay == '未支付')
        <div class="order-status weui-cell">
          <div class="weui-cell__hd">
            ...
            <div class="tips">逾期未付款，订单将自动取消</div>
          </div>
          <div class="weui-cell__ft">
    ...
    <div class="weui-form-preview">       
        <div class="weui-form-preview__bd">
            ...
            <div class="weui-form-preview__item">
                ...
                <span class="weui-form-preview__value">{{$order->price}}</span>
            </div>
    ...
    @else
      @if ($order->order_pay == '未支付')
        <div class="checkwrapper product-checker">
          <span style="margin-left: 0.75rem; font-size: 0.6rem;">实付款</span> <span class="price_final" id="total"> ¥ {{$order->price}}</span>
          <a class="right-botton01" href="javascript:;" id="showIOSActionSheet" onclick="wechatPay()">立即支付</a>
