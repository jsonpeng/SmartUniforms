...
@section('content')
<div ><img src="{!! asset('images/proxy1.png') !!}" style="width: 100%;height: auto;    margin-bottom: -5px;" /></div>
<div ><img src="{!! asset('images/proxy2.png') !!}" style="width: 100%;height: auto;    margin-bottom: -5px;" /></div>
