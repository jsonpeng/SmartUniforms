...
@section('content')
    ...
    <div class="userInfo">
        <img class="bg" src="{{ asset('images/default_01/usercenter.jpg') }}" alt="">
{{--         <div class="add">
    ...
    <div class="weui-cells">
        <a class="weui-cell weui-cell_access" href="/mySchoolProduct">
            <div class="weui-cell__bd">
                <p>我的校服</p>
            </div>
            <div class="weui-cell__ft"></div>
    ...
    <div class="weui-cells">
        <a class="weui-cell weui-cell_access" href="/consultRecords/征订单">
            <div class="weui-cell__bd">
                <p>我的征询单</p>
            </div>
            <div class="weui-cell__ft"></div>
        ...
        <div class="weui-cells">
        <a class="weui-cell weui-cell_access" href="/consultRecords">
            <div class="weui-cell__bd">
                <p>我的调换单</p>
            </div>
            <div class="weui-cell__ft"></div>
