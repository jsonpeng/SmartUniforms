...
<head>
    ...
    <style>
        ...
        /*#weui-tabbar .weui-tabbar__item p{color:{{ themeMainColor()}};}*/
        /*#weui-tabbar .weui-tabbar__item  .icon{color:{{ themeMainColor()}}; }*/
        /*#weui-tabbar .weui-bar__item_on{background-color:{{ themeMainColor()}}; }*/
        ...
        #weui-tabbar{background-color: #000;}
    </style>
</head>
<body>
    <style>
        ...
        .layui-m-layerbtn span[yes]{color: orange;}
