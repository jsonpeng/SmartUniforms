    ...
    <div class="classreturn loginsignup detail">
        <div class="content">
            ...
            <div class="ds-in-bl search center" id="topcenter">
                <span class="tag_product" onclick="anchorProduct()">商品详情</span>
            </div>
            <div class="ds-in-bl share-pic">
                <i class="icon ion-ios-heart-outline"></i><i class="icon ion-share"></i>
            </div>
        </div>
    </div>
  </div>
  ...
  <div class="scroller" id="scroller">
        ...
        <div class='swipe-wrap'>
            @foreach ($productImages as $productImage)
              <div class="swiper-slide">
                <div class="img">
                    <img src="{{ $productImage->url }}" class="swiper-lazy">
                </div>
    ...
    <div id="product_detail">
      ...
      <div class="promise">
        ...
        @endforeach
        <div class="promise-item"><i class="icon ion-ios-checkmark-outline"></i>包邮</div>
        <div class="promise-item"><i class="icon ion-ios-checkmark-outline"></i>包邮</div>
      </div>
      <!-- 服务承诺 end  -->
      ...
      <!-- 猜你喜欢 
      <div class="mebyLike" style="background-color: #fff;padding-top: 1.5rem; margin-top:5px;">
        <div class="theme-title">
            <div class="content"><img src="{{ asset('images/default/heart.png') }}" style="vertical-align: middle; margin-right: 10px;">猜你喜欢</div>
        </div>
      </div>
      ...
      <div class="product-wrapper">
        @foreach ($relatedProducts as $element)
          <a class="product-item2" href="/product/{{$element->id}}">
            ...
            <div class="price">¥{{ $element->price }} <span>{{ $element->sales_count }}人购买</span></div>
          </a>
        @endforeach
      </div>-->
      <!-- 猜你喜欢 end -->
      ...
      <div class="more" id="more">
        <i class="ion-android-arrow-up pull_icon"></i>
        <span>上拉查看详情...</span>
      </div>
...
<div class="content1" style="display: none;">
 ...
 -->
  <!-- 弹出商品规格选择框 -->
  <div class="item-mask" style="z-index: 99999999;">
